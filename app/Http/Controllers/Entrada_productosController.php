...
class Entrada_productosController extends Controller
{
 ...
 public function __construct(){
  ...
  //return view('remision',compact('remision','solicitante','compania','area','productoss'));
       ...
       if ((Auth::user()->id_perfil ==3 )) {
           return view('entrada',compact('remision','solicitante','compania','area','productoss','categorias','almacen'));
       }else{
...
foreach($_POST["id"] as $b=>$a)
{
  ...
  //return view('detalle_remision',compact('remision','solicitante','compania','area','cantidad','codigoo'));
      ...
      if ((Auth::user()->id_perfil ==3 )) {
       return view('detalle_entrada',compact('remision','solicitante','compania','area','cantidad','codigoo'));
       }else{
